...
def parser_train():
    ...
    parser.add_argument('--attack-eps', type=str2float, default=1/255, help='Epsilon for the attack.')
    parser.add_argument('--attack-step', type=str2float, default=1/1020, help='Step size for PGD attack.')
    ...
    parser.add_argument('--mul', type=int, default=1, help='Multiplier for attack eps and attack step.')
    ...
    '''ADDED NEW ARGUMENT'''
    parser.add_argument('-ni', '--num-iadv-epochs', type=int, default=0, help='Number of inverse adversarial training epochs.')
    parser.add_argument('-nw', '--num-wrong-label', type=int, default=0, help='Number of wrong label adversarial training epochs.')
